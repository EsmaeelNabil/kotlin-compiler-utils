...
public class LibrariesForDepsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>kotlinCompilerEmbeddable</b> with <b>org.jetbrains.kotlin:kotlin-compiler-embeddable</b> coordinates and
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getKotlinCompilerEmbeddable() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("kotlinCompilerEmbeddable");
    }
    ...
    /**
     * Group of libraries at <b>autoService</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public AutoServiceLibraryAccessors getAutoService() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
    ...
    public static class AutoServiceLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>autoService</b> with <b>com.google.auto.service:auto-service-annotations</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("autoService");
        }

        /**
         * Dependency provider for <b>ksp</b> with <b>dev.zacsweers.autoservice:auto-service-ksp</b> coordinates and
    ...
    public static class KspLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>ksp</b> with <b>com.google.devtools.ksp:symbol-processing</b> coordinates and
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>autoService</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>compose.plugin</b> with value <b>1.7.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final CompilerPluginAccessors paccForCompilerPluginAccessors = new CompilerPluginAccessors(providers, config);
        ...
        /**
         * Plugin provider for <b>kmp</b> with plugin id <b>org.jetbrains.kotlin.multiplatform</b> and
         * with version reference <b>kotlin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKmp() { return createPlugin("kmp"); }
        ...
        /**
         * Plugin provider for <b>mavenPublish</b> with plugin id <b>com.vanniktech.maven.publish</b> and
         * with version <b>0.30.0</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Group of plugins at <b>plugins.compiler</b>
         */
        public CompilerPluginAccessors getCompiler() {
            return paccForCompilerPluginAccessors;
        }
    ...
    public static class CompilerPluginAccessors extends PluginFactory {

        public CompilerPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>compiler.plugins</b> with plugin id <b>dev.supersam.compilerGradlePlugin</b> and
         * with version <b>0.0.1</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugins() { return createPlugin("compiler.plugins"); }

        /**
         * Plugin provider for <b>compiler.plugins2</b> with plugin id <b>dev.supersam.compilerGradlePlugin.gradle.plugin</b> and
         * with version <b>0.0.1</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugins2() { return createPlugin("compiler.plugins2"); }
